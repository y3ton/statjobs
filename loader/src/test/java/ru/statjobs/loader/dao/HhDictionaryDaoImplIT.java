...
public class HhDictionaryDaoImplIT {
    ...
    public void getCityTest() {
        HhDictionaryDao dao = new HhDictionaryDaoImpl(null);
    ...
    public void getIndustriesTest() {
        ...
        HhDictionaryDao dao = new HhDictionaryDaoImpl(jsonUtils);
        ...
        Mockito.verify(jsonUtils, Mockito.times(1)).readResource(Mockito.anyString());
        dao.getIndustries();
        Mockito.verify(jsonUtils, Mockito.times(1)).readResource(Mockito.anyString());
    }
